...
def slr_operations():
    ...
    print(f'Correlation = {slr.get_coefficient_correlation()}')

    # Coefficient of Determination
    slr.to_compute_coefficient_determination()
    print(f'Determination = {slr.get_coefficient_determination()}')
...
def qr_operations():
    ...
    print('\nCoefficients')
    qr.to_compute_coefficient_correlation(data_set.get_x(), data_set.get_y(), data_set.get_n())
    print(f'Correlation = {qr.get_coefficient_correlation()}')

    qr.to_compute_coefficient_determination()
    print(f'Determination = {qr.get_coefficient_determination()}')
...
def cr_operations():
    ...
    print('\nCoefficients')
    cr.to_compute_coefficient_correlation(data_set.get_x(), data_set.get_y(), data_set.get_n())
    print(f'Correlation = {cr.get_coefficient_correlation()}')

    cr.to_compute_coefficient_determination()
    print(f'Determination = {cr.get_coefficient_determination()}')
